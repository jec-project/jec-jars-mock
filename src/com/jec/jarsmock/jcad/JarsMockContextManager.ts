...
import {JarsMockConnector} from "./connectors/JarsMockConnector";
...
/**
* A helper class that is used to manage Mock desciptor contexts for the JARS
* specification.
*/
export class JarsMockContextManager {
  ...
  /**
  * Creates a new <code>JarsMockContextManager</code> instance.
  */
  constructor() {}
  ...
  */
  private initContext(jcadReference:string, decoratorClass:any):void {
    ...
    const connector:DecoratorConnector =
                                new JarsMockConnector(jcadReference, decorator);
