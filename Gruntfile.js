...
/*
 * Provides tasks for building and testing the jec-jars-mock project.
 */
module.exports = function(grunt) {
  ...
  //--> Task: builds the "jec-jars-mock" project:
  grunt.registerTask("build", ["ts:build", "copy:main",
                               "copy:initTypes", "copy:buildTypesFile",
                               "clean:build"]);

  //--> Task: builds the "jec-jars-mock" API documentation:
