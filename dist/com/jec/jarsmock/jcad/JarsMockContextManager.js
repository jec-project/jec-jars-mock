...
const JarsMockConnector_1 = require("./connectors/JarsMockConnector");
...
class JarsMockContextManager {
    ...
    initContext(jcadReference, decoratorClass) {
        ...
        const connector = new JarsMockConnector_1.JarsMockConnector(jcadReference, decorator);
...
exports.JarsMockContextManager = JarsMockContextManager;
